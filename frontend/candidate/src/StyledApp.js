...
const useStyles = makeStyles((theme) => ({
  ...
  ca_jobdetails_dotted_container: {
    display: "flex",
    width: "100%",
    justifyContent: "space-around",
    alignItems: "center",
  ...
  ca_jobdetails_concept_list: {
    width: "100%",
    display: "flex",
    flexDirection: "column",
  },
  ca_jobdetails_concept_list_row: {
    display: "flex",
    flexDirection: "row",
    justifyContent: "start",
    alignItems: "center",
  ...
  ca_jobdetails_job_desc_div: {
    height: '18rem',
    marginBottom: '3.5rem',
  },
  ca_jobdetails_contact_list: {
    width: "100%",
    display: "flex",
    flexDirection: "column",
  },
  ca_jobdetails_contact_list_row: {
    display: "flex",
    flexDirection: "row",
    justifyContent: "left",
    alignItems: "center",
