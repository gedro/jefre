...
export default function JobDetails({ classes, appContext, onAppContextChanged, history }) {
  ...
  const fetchJobData = async (jobId) => {
    try {
      ...
      const response = await appContext.api.get(`/candidate/jobs/${jobId}`);
  ...
  return (
    <Fragment>
      {loading ? ( <Loader /> ) : (
        <Fragment>
          <div className={classes.ca_jobdetails}>
            <div>
              <h1 className={classes.ca_jobdetails_h1}>
                {job?.title || 'Missing title'}
                <hr className={classes.ca_jobdetails_hr}/>
              </h1>
              <h4 className={classes.ca_jobdetails_h4}>
                <span><u>End date:</u> {job?.vacancyEndDate || ' - '}</span>
                <span>{job?.country}{job?.city && ' - ' + job.city}</span>
              </h4>
            </div>
            <div className={classes.ca_jobdetails_form_line}>
              <div className={classes.ca_jobdetails_dotted_container}>
                <div className={classes.ca_jobdetails_dotted}>
          ...
          <div className={classes.ca_jobdetails}>
            <h1 className={classes.ca_jobdetails_h1}>Contact Information</h1>
            <hr className={classes.ca_jobdetails_hr}/>
            <div className={classes.ca_jobdetails_form_line}>
              <div className={classes.ca_jobdetails_contact_list}>
                {job?.companyName && (
                  <div className={classes.ca_jobdetails_contact_list_row}>
          ...
          <div className={classes.ca_jobdetails}>
            <h1 className={classes.ca_jobdetails_h1}>Occupations</h1>
            <hr className={classes.ca_jobdetails_hr}/>
            <div className={classes.ca_jobdetails_form_line}>
              <div className={classes.ca_jobdetails_concept_list}>
                {job?.occupations?.map((occupation) => (
                  <div key={occupation?.id} className={classes.ca_jobdetails_concept_list_row}>
          ...
          <div className={classes.ca_jobdetails}>
            <h1 className={classes.ca_jobdetails_h1}>Skills</h1>
            <hr className={classes.ca_jobdetails_hr}/>
            <div className={classes.ca_jobdetails_form_line}>
              <div className={classes.ca_jobdetails_concept_list}>
                {job?.skills?.map((skill) => (
                  <div key={skill?.id} className={classes.ca_jobdetails_concept_list_row}>
                    <div style={{paddingRight: "4em", display: 'flex'}}>
          ...
          <div className={classes.ca_jobdetails}>
            <h1 className={classes.ca_jobdetails_h1}>Job Description</h1>
            <hr className={classes.ca_jobdetails_hr}/>
            <div className={classes.ca_jobdetails_job_desc_div}>
              {job?.description && (
